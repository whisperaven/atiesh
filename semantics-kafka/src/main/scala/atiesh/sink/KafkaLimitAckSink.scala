...
/**
 * Kafak sink implement on top of the LimitAck Semantics.
 */
class KafkaLimitAckSink(name: String, dispatcher: String, cfg: Configuration)
  extends AtieshSink(name, dispatcher, cfg)
  with KafkaLimitAckSinkSemantics
  with Logging {
