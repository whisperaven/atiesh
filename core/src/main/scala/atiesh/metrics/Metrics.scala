...
import kamon.metric.{ Counter => MCounter, Gauge => MGauge,
                      ...
                      RangeSampler => MRangeSampler,
                      MeasurementUnit => MMeasurementUnit, _ }
// scala
...
object Metrics extends Component with MetricsType with Logging {
  ...
  /* measurement unit */
  type MeasurementUnit = MMeasurementUnit
  object MeasurementUnit {
    val none = MMeasurementUnit.none
    val bytes = MMeasurementUnit.information.bytes
    val seconds = MMeasurementUnit.time.seconds
  }
  val emptyMeasurementUnit = MMeasurementUnit.none
